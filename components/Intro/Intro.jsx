...
function Intro() {
	...
	return (
		<div>
			<h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">Enkhtur Enkhbold</h1>
			<h2 className="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">Mobile Developer</h2>
