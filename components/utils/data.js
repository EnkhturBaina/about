...
export const experiences = [
	{
		job_start: 2018,
		job_end: "present",
		company_name: "Digital Credit LLC",
		company_link: "https://digitalcredit.mn/",
		designation: "Full-Stack Developer",
		description:
			"Introduced “Digital Credit” system, which is a dedicated system for financial institutions; also introduced complex loan control system for Small and Medium Enterprises Agency which is Implementing Agency of Mongolian Government that enables them to receive project proposals online, analyze them with less human involvement.",
		description_list: ["Digital credit system", "Zeelme – Loan supermarket", "Autohuleg.mn", "Cashme"],
		tags: ["React JS", "React Native", "Veritech ERP", "jQuery", "JavaScript", "CSS", "Oracle"]
	},
	{
		job_start: 2022,
		job_end: "present",
		company_name: "GameMine LLC",
		company_link: "https://gamemine.mn/",
		designation: "Mobile Developer",
		description:
			"Game Mine LLC is an information technology company operating in Mongolia. The company develops human resource management systems and mine dispatch systems.",
		description_list: ["TalentMN", "Play-Fleet"],
		tags: ["React Native"]
	},
	{
		job_start: 2022,
		job_end: "present",
		company_name: "Gurensoft LLC",
		designation: "Mobile Developer",
		description:
			"Gurensoft LLC is an information technology company operating in Mongolia, developing software development, digital solutions, and online service platforms. The company aims to introduce innovative and efficient applications to the market and offers technology solutions that meet the needs of its customers.",
		description_list: ["e-Merged", "iWash Guren", "HubStar", "iHospital.mn", "iBalance"],
		tags: ["React Native"]
	}
];
